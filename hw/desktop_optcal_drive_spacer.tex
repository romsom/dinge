...
\noindent\begin{tikzpicture}[node distance=1cm]
  ...
  \foreach \height/\width/\toothheight in {23.5mm/110mm/2mm} {
    ...
    \draw[cut] (tooth1_nw) -- (tooth1_sw);
    \draw[cut] (tooth1_sw) -- (tooth1_se);
    \draw[cut] (tooth1_se) -- (tooth1_ne);
    \draw[cut] (tooth1_ne) -- (tooth2_nw);

    \draw[cut] (tooth2_nw) -- (tooth2_sw);
    \draw[cut] (tooth2_sw) -- (tooth2_se);
    \draw[cut] (tooth2_se) -- (tooth2_ne);
